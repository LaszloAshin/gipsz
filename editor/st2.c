...
int st2PutObject(object_t *o) {
  ...
  foc.p[foc.n].y = o->y;
  foc.p[foc.n].z = o->z;
  foc.p[foc.n].rot = (o->a & 3) | ((o->b & 3) << 3) | ((o->c & 3) << 6);
  return foc.n++;
}

int st2GetObject(object_t *o) {
  if (foc.r == foc.n) {
    foc.r = 0;
    return 0;
  }
  ...
  o->y = foc.p[foc.r].y;
  o->z = foc.p[foc.r].z;
  o->a = foc.p[foc.r].rot & 3;
  o->b = (foc.p[foc.r].rot >> 3) & 3;
  o->c = (foc.p[foc.r].rot >> 6) & 3;
  ++foc.r;
  return !0;
}
